    ...
    <footer className="bg-gray-950" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-24">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 lg:mr-16">
            <Image
              className='max-w-xs'
              src={logo}
              alt="Company name"
            ...
            <p className="text-sm leading-6 text-gray-300">
              Iconika es una agencia de representación de modelos emergentes en la industria del contenido para adultos.
            </p>
          ...
          <div className="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-10 md:mt-0 hidden lg:inline-block">
